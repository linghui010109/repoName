...
public:
    ...
    virtual void insert(const Comparable& value) = 0;
    //virtual void insert(Comparable& value) = 0;
    virtual void remove(const Comparable& value) = 0;
    virtual bool contains(const Comparable& value) const = 0;
